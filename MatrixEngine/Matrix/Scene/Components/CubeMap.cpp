...
std::shared_ptr<Shaders::ShaderProgram> Scene::Components::CubeMap::shader;
std::shared_ptr<Shaders::ShaderSource> Scene::Components::CubeMap::shader_vert;
std::shared_ptr<Shaders::ShaderSource> Scene::Components::CubeMap::shader_frag;
...
Scene::Components::CubeMap::CubeMap()
{
	if (!init) {
		...
		shader_vert = std::make_shared<Shaders::ShaderSource>();
		shader_frag = std::make_shared<Shaders::ShaderSource>();
		shader		= std::make_shared<Shaders::ShaderProgram>();
