...
class Shaders::ShaderSource
{
public:
	ShaderSource();
	~ShaderSource();

	void LoadFromFile(GLenum shader_type, std::string shader_file);
	void InitWithSource(GLenum shader_type, const GLchar *shader_source);
