...
public class SDLActivity extends Activity {
    private static final String TAG = "SDLActivity.Java";
    ...
    // Load the .so
    static {
        Log.i(TAG, "Loading libSDL2.so");
		try {
			System.loadLibrary("SDL2");
		} catch(UnsatisfiedLinkError err) {
			Log.e(TAG, "Exception loading lib: " + err.getMessage());
		}

		Log.i(TAG, "Loading libSDL2_image.so");
		try {
